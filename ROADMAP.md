...
> Первоначальный план. Актуальные приоритеты и обзор текущей архитектуры находятся в [TODO.md](TODO.md) (15.09.2026). Пункты ниже про chi, React и SDK — прежние предложения, а не описание реализованного стека.
